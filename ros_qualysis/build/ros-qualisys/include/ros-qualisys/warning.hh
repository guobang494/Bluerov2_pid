...
#ifndef ROS_QUALISYS_WARNING_HH
# define ROS_QUALISYS_WARNING_HH

// Emits a warning in a portable way.
//
// To emit a warning, one can insert:
//
// #pragma message ROS_QUALISYS_WARN("your warning message here")
//
...
# define ROS_QUALISYS_WARN_STRINGISE(x) \
         ROS_QUALISYS_WARN_STRINGISE_IMPL(x)
# ifdef __GNUC__
#   define ROS_QUALISYS_WARN(exp) ("WARNING: " exp)
# else
#  ifdef _MSC_VER
#   define FILE_LINE_LINK __FILE__ "(" \
           ROS_QUALISYS_WARN_STRINGISE(__LINE__) ") : "
#   define ROS_QUALISYS_WARN(exp) (FILE_LINE_LINK "WARNING: " exp)
#  else
