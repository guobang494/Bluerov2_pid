...
if(NOT ros-qualisys_FOUND)
  set(skip_this_file FALSE)
endif()
if(skip_this_file)
  foreach(component ${ros-qualisys_FIND_COMPONENTS})
    if(NOT "ros-qualisys_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("ros-qualisys_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("ROS_QUALISYS_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("ros-qualisys_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/ros-qualisys/doxygen-html")
set("ROS_QUALISYS_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/ros-qualisys/doxygen-html")
set("ros-qualisys_DEPENDENCIES" "")
set("ros-qualisys_PKG_CONFIG_DEPENDENCIES" "")
...
set("_ros-qualisys_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_ros-qualisys_PKG_CONFIG_LIBS_LIST" "")
if(_ros-qualisys_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_ros-qualisys_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _ros-qualisys_PKG_CONFIG_LIBS_LIST "${_ros-qualisys_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_ros-qualisys_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _ros-qualisys_PKG_CONFIG_LIBS_LIST "${_ros-qualisys_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_ros-qualisys_PKG_CONFIG_LIBDIR})
  foreach(component ${_ros-qualisys_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_ros-qualisys_PKG_CONFIG_LIBS_LIST)

set("ros-qualisys_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("ROS_QUALISYS_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${ros-qualisys_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/ros-qualisysTargets.cmake")
...
foreach(component ${ros-qualisys_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(ros-qualisys_${component}_FOUND FALSE)
  endif()
  if(ros-qualisys_${component}_FOUND)
    message(STATUS "ros-qualisys: ${component} found.")
  else()
    if(ros-qualisys_FIND_REQUIRED_${component})
      message(FATAL_ERROR "ros-qualisys: ${component} not found.")
    else()
      message(STATUS "ros-qualisys: ${component} not found.")
    endif()
  endif()
endforeach()
check_required_components("ros-qualisys")
